      ...
      >
        <div className="flex items-center h-5 mt-0.5">
          <input
            ...
            ref={ref}
            type="radio"
            className="w-4 h-4 rounded-full border-namora-line bg-namora-bg text-namora-gold focus:ring-2 focus:ring-namora-gold/40 cursor-pointer accent-namora-gold"
            {...props}
          />
        </div>
